...
const Feedback = (): JSX.Element => {
  ...
  return isMessageSent ? (
    <FeedbackMessage setIsMessageSent={setIsMessageSent} />
  ) : (
    <section className={classes["feedback"]}>
      <div className={classes["feedback__text"]}>
        Данный раздел необходим для получения прямой обратной связи от наших
        клиентов и&nbsp;партнеров о том, каких виджетов в{" "}
        <a href={marketLink}>REON.Маркет</a> Вам не хватает и какой функционал
        необходимо добавить или доработать в том или ином виджете. Все свои идеи
